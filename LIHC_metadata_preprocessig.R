...
st_data <- data.table::fread('/N/project/degas_st/cosmyx/Cosmx_liver_data.csv')
...
data.table::fwrite(st_data_out, '/N/project/degas_st/cosmyx/data/processed/liver/cosmyx_liver_data.csv')
